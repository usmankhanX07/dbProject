        ...
        <div class="container0">
            ...
            <form action="php/query.php" method="post">
                <div class="m1">
                    ...
                    <input type="text" name="custName" id="" class="form-control" placeholder="" aria-describedby="helpId"/>
                </div>
                <div class="m1">
                    ...
                    <table class="custom-table">    
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm btn-info" href="booking.php?myFlight=<?php echo $flight['Flight_ID']?>">Yes</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
